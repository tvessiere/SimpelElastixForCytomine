...
if __name__ == "__main__":
    ...
    software = conn.add_software("SimpleElastixV19","createRabbitJobWithArgsService","download","/root/miniconda2/envs/cytomine/bin/python /software_router/algo/simple_elastix/get_and_move.py "+
                                                                                                     "--cytomine_host $host " +
